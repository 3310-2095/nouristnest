             ...
             <div className="row">
                ...
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                   <div className="tpfooter__widget footer-col-2 mb-50">
                      <h4 className="tpfooter__widget-title">Looking for NOURIST NEST?</h4>
                ...
                <div className="col-xl-4 col-lg-6 col-md-8 col-sm-7">
                   <div className="tpfooter__widget footer-col-4 mb-50">
                      ...
                      <div className="tpfooter__widget-newsletter">
                         <p>Subscribe to the NOURIST NEST mailing list to receive updates <br/> on new arrivals & other information.</p>
                         <form>
                            <span>
                              <i>
