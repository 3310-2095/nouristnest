...
export const metadata: Metadata = {
  title: "Nourist Nest – Shop Better. Live Better.",
  description: "Nourist Nest brings fresh,nutritious,and wholesome products right to your doorstep. Shop smart, live well,every day.",
};
