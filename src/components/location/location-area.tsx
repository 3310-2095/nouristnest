        ...
        <div className="tplocation__text">
          ...
          <div className="tplocation__content tplocation__content-two">
              <ul>
                ...
                <li>
                    <a href="mailto:nouristnest@google.com">Email: {email}</a>
                </li>
                <li>
       ...
       <div className="row">
          <div className="col-lg-6">
             <div className="tplocation__wrapper mb-30">
              <LocationItem img="1" title="Rue Pelleport - Paris" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 7890" email="nouristnest@google.com" open="09:00 AM - 18:00 PM" />
              <LocationItem img="2" title="Prospect - New York" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 8899" email="nouristnest@google.com" open="09:00 AM - 18:00 PM" />
              <LocationItem img="3" title="Budapest - Hung" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 7755" email="nouristnest@google.com" open="09:00 AM - 18:00 PM" />
              <LocationItem img="4" title="Kastrup - Denmark" add="Heaven Stress, Beverly Contributors" phone="(+100) 123 456 5544" email="nouristnest@google.com" open="09:00 AM - 18:00 PM" />
             </div>
          </div>
          <div className="col-lg-6">
